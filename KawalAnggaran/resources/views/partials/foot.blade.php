<link href="{{ asset('css/footstyle.css') }}" rel="stylesheet">
<footer>
    ...
    <div class="bottomFooter">
        <div class="textContact">
            <p class="contactFooter">(+62) 85426754163</p>
            <p class="contactFooter">admin@kawalanggaran.id</p>
        ...
        <div class="logoFooter">
            <a href="#header"><img src="{{ asset('img/logo.png') }}" alt=""></a>
        </div>
    </div>
</footer>
<script>
